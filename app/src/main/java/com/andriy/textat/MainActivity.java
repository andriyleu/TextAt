...
public class MainActivity extends AppCompatActivity
    ...
    private GoogleMap map; // map inside fragment
    private LocationManager locationManager; // gps handler
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // center camera when pressing some point
        ...
        /*map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker arg0) {
                CameraPosition obj_cam = new CameraPosition.Builder()
                        ...
                        .build();
                map.animateCamera(CameraUpdateFactory.newCameraPosition(obj_cam));
                return true;
            }
